...
type SeparatedList = <I, O1, O2>(separator: Parser<I, O1>, separated: Parser<I, O2>) => Parser<I, Array<O2>>
export const separatedList: SeparatedList = <I, O1, O2>(separator: Parser<I, O1>, separated: Parser<I, O2>) => {
  return (input: I) => {
